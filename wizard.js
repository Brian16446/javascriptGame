class Wizard extends Player{
    ...
    equipWeapon(){
        ...
        this.weaponSheet = PIXI.Loader.shared.resources["assets/Roguelike Sprites/Items/Weapons/Staff/staff.json"].spritesheet;
        console.log(this.weaponSheet);
        this.weapon = new PIXI.AnimatedSprite(this.weaponSheet.animations["staff"]);
